...
public class CustomZXingScannerView extends View implements IViewFinder {
    ...
    public synchronized void updateFramingRect() {
        ...
        if (mSquareViewFinder) {
            ...
            if (orientation != Configuration.ORIENTATION_PORTRAIT) {
                height = (int) (getHeight() * LANDSCAPE_HEIGHT_RATIO) + 100;
                width = (int) (LANDSCAPE_WIDTH_HEIGHT_RATIO * height) + 100;
            } else {
                width = (int) (getWidth() * PORTRAIT_WIDTH_RATIO) + 100;
                height = (int) (PORTRAIT_WIDTH_HEIGHT_RATIO * width) + 100;
            }
        }
